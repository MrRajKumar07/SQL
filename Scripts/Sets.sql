...
/* TASK 6: 
   Find all customer IDs who placed orders in either orders or orders_archive.(Use UNION)
*/
...
/* TASK 7: 
   Find all customer IDs who placed orders in both orders and orders_archive
*/
...
/* TASK 7: 
   List all product categories that appear in products but have never been sold in orders or orders_archive.
*/
...
SELECT DISTINCT p.category
FROM products p
JOIN orders_archive oa ON p.productid = oa.productid;
